  ...
  head: () => ({
    meta: [
      ...
      { title: "CrickSense — AI cricket technique analysis for women" },
      {
        name: "description",
        content:
          "CrickSense uses MediaPipe computer vision and AI to analyze women cricketers' bowling and batting biomechanics with personalized benchmarks.",
      },
      { name: "author", content: "CrickSense" },
